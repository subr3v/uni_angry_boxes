...
int main()
{
	...
	PhysicsObject* obj = simulation.createObject(1, Vector2(190, 300), OrientedBoundingBox(Vector2(0, 0), 10, 50, 0));
	...
	PhysicsObject* ground = simulation.createObject(0, Vector2(400, 600 - 120), OrientedBoundingBox(Vector2(0, 0), 600, 120, 0));
